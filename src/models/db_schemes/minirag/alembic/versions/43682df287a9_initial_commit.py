...
Revision ID: 43682df287a9
Revises: 
Create Date: 2025-11-09 14:17:10.163805
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_asset_type', table_name='chunks')
    op.drop_index('ix_asset_project_id', table_name='chunks')
