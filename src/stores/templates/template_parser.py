...
class TemplateParser:
    ...
    def set_language(self, language: str):
        ...
        if language and os.path.exists(os.path.join(language_path)): 
    ...
    def get(self, group: str, key: str, vars: dict={}):
        ...
        # check if the given language does not exists, if so, change the group path to the default one(deafult language)
